...
})(["font-size:3em;line-height:1.3em;letter-spacing:-0.02em;margin-bottom:1.7em;font-weight:800;word-break:keep-all;@media (max-width:968px){font-size:2em;}@media (max-width:768px){font-size:1.8em;margin-bottom:1.2em;}"]);
...
})(["padding:3em 1em;.meta{padding-bottom:2em;&:after{content:\"\";display:block;clear:both;}.tags{float:left;border-left:1px solid #eee;padding-left:0.6em;}.date{float:left;margin-right:1em;color:#8794a3;}}.post-body{padding-top:2em;border-top:1px solid #eee;}"]);
...
//# sourceMappingURL=[id].js.d58e14b4adedce8f2803.hot-update.js.map