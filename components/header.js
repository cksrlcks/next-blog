    ...
    <Header>
      <div className="global-inner">
        ...
        <nav className="gnb">
          ...
          <ActiveLink prefetch={true} href="/blog" activeClassName="active">
            <a>블로그</a>
          </ActiveLink>
          <ActiveLink prefetch={true} href="/study" activeClassName="active">
            <a>공부</a>
          </ActiveLink>
          <ActiveLink prefetch={true} href="/work" activeClassName="active">
            <a>작업</a>
          </ActiveLink>
        </nav>
